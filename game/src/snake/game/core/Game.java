...
public class Game {
    ...
    public void start() {
       ...
       gameWindow = new GameWindow(
               ...
               gameConfig.applicationConfig().minMillisBetweenKeyPressedEvents()
       );
    ...
    private void addElementsToScreen() {
        gameWindow.addDrawable(new Background(
                gameConfig.window().width(),
                gameConfig.window().height(),
                Color.valueOf(gameConfig.window().backgroundColor())));
    ...
    private boolean isGameOver() {
        return !running || snake.collideWithItSelf() || snake.collideWithWindowBounds(gameWindow.drawingArea());
    }

    private void processGameOver() {
        gameWindow.removeDrawable(snake);
        gameWindow.removeDrawable(food);
        gameWindow.addDrawable(new GameOverText(food.getEatTimes(), gameConfig.window(), gameConfig.gameOver()));
        gameWindow.update();
    }
